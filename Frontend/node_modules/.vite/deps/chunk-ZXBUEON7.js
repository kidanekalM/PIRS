...
var TextareaAutosize = React3.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const renders = React3.useRef(0);
  const [state, setState] = React3.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React3.useCallback(() => {
  ...
  return (0, import_jsx_runtime5.jsxs)(React3.Fragment, {
    children: [(0, import_jsx_runtime4.jsx)("textarea", _extends({
      value,
    ...
    }, other)), (0, import_jsx_runtime4.jsx)("textarea", {
      "aria-hidden": true,
...
function useSlider(parameters) {
  ...
  const previousIndex = React6.useRef();
...
function useSnackbar(parameters = {}) {
  ...
  const timerAutoHide = React7.useRef();
  React7.useEffect(() => {
    if (!open) {
      return void 0;
    }
  ...
  const handleResume = React7.useCallback(() => {
...
var Badge = React8.forwardRef(function Badge2(props, forwardedRef) {
...
var Button = React10.forwardRef(function Button2(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children,
...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React12.useRef(initialState);
  React12.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React12.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const controlledPropsRef = React12.useRef(controlledProps);
  if (true) {
    React12.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
  ...
  const reducerWithControlledState = React12.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    const newState = reducer(controlledState, action);
    return newState;
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React12.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React12.useCallback((action) => {
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React13.useState("");
  const [triggerElement, setTriggerElement] = React13.useState(null);
  const lastActionType = React13.useRef(null);
  const handleStateChange = React13.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null || onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React13.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
var FormControl = React16.forwardRef(function FormControl2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime10.jsx)(FormControlContext.Provider, {
    value: childContext,
...
function useFormControlContext() {
  return React17.useContext(FormControlContext);
}
...
var ListContext = React22.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const createHandleClick = React23.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React23.useCallback((externalHandlers) => (event) => {
...
var CompoundComponentContext = React24.createContext(null);
...
function useCompoundParent() {
  const [subitems, setSubitems] = React24.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React24.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React24.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React24.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React24.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React24.useCallback(function getItemIndex2(id) {
...
function useMenu(parameters = {}) {
  ...
  const reducerActionContext = React26.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
var Menu = React28.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime14.jsx)(Popper, _extends({}, rootProps, {
    open,
    anchorEl: anchor,
    slots: {
      root: Root
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React35.useState(value ? String(value) : void 0);
  React35.useEffect(() => {
  ...
  const handleValueChange = () => (event, val) => {
    ...
    if (val === void 0) {
      ...
      newValue = clampStepwise(val, min2, max2, step);
...
var COMPONENT_NAME12 = "Popup";
function getPopupUtilityClass(slot) {
  return generateUtilityClass(COMPONENT_NAME12, slot);
}
var popupClasses = generateUtilityClasses(COMPONENT_NAME12, ["root", "open"]);
...
var _excluded13 = ["anchor", "children", "container", "disablePortal", "keepMounted", "middleware", "offset", "open", "placement", "slotProps", "slots", "strategy", "withTransition"];
...
true ? Popup.propTypes = {
   ...
   */
  middleware: import_prop_types16.default.arrayOf(import_prop_types16.default.oneOfType([import_prop_types16.default.oneOf([false]), import_prop_types16.default.shape({
    fn: import_prop_types16.default.func.isRequired,
    name: import_prop_types16.default.string.isRequired,
    options: import_prop_types16.default.any
  })])),
  /**
   ...
   */
  offset: import_prop_types16.default.oneOfType([import_prop_types16.default.func, import_prop_types16.default.number, import_prop_types16.default.shape({
    alignmentAxis: import_prop_types16.default.number,
    crossAxis: import_prop_types16.default.number,
    mainAxis: import_prop_types16.default.number
  })]),
  /**
   ...
   * @default false
   */
  withTransition: import_prop_types16.default.bool
} : void 0;
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime26.jsx)(React49.Fragment, {
...
var Select = React49.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React49.Fragment, {
...
var _excluded15 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var Slider = React50.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime28.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime28.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime29.jsxs)(React50.Fragment, {
...
var Snackbar = React51.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React53.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React54.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React55.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React56.useCallback((event, newValue) => {
    setValue(newValue);
    onChange == null || onChange(event, newValue);
  }, [onChange, setValue]);
  const {
  ...
  const tabIdLookup = React56.useRef(() => void 0);
  const getTabPanelId = React56.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React56.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React56.useCallback((lookupFunction) => {
...
var TabsContext = React57.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React57.useContext(TabsContext);
  if (context == null) {
...
function TabsProvider(props) {
  ...
  const compoundComponentContextValue = React58.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
  const tabsContextValue = React58.useMemo(() => ({
    direction,
    getTabId,
    getTabPanelId,
    onSelected,
...
var Tabs = React59.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React60.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React61.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var TabsList = React64.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabRef = React65.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React65.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React66.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
function CssAnimation(props) {
  ...
  const hasExited = React67.useRef(true);
  React67.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React67.useCallback((event) => {
...
var CssTransition = React68.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React68.useState(false);
  React68.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React68.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZXBUEON7.js.map
