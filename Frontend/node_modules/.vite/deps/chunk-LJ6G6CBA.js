...
var TabScrollButton = React2.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime2.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    ...
    children: direction === "left" ? (0, import_jsx_runtime2.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime2.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
var Tabs = React3.forwardRef(function Tabs2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React3.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React3.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React3.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React3.useState(false);
  const [scrollerStyle, setScrollerStyle] = React3.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React3.useRef(null);
  const tabListRef = React3.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React3.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime3.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime3.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime3.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime3.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  const children = React3.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React3.cloneElement(child, _extends({
  ...
  return (0, import_jsx_runtime4.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime4.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime3.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
//# sourceMappingURL=chunk-LJ6G6CBA.js.map
