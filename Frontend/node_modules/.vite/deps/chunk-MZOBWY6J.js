    ...
    defaultizedSeries[seriesId] = _extends({
      ...
      data: series[seriesId].data.map((item, index2) => {
        ...
        return _extends({}, item, {
          id: (_item$id = item.id) != null ? _item$id : `auto-generated-pie-id-${seriesId}-${index2}`
        }, arcs[index2]);
      }).map((item) => {
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React3.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React5.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React6.createElement(Provider, { value: props }, children);
};
...
function value_default(a2, b) {
  var t = typeof b, c6;
  return b == null || t === "boolean" ? constant_default2(b) : (t === "number" ? number_default : t === "string" ? (c6 = color(b)) ? (b = c6, rgb_default) : string_default : b instanceof color ? rgb_default : b instanceof Date ? date_default : isNumberArray(b) ? numberArray_default : Array.isArray(b) ? genericArray : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default : number_default)(a2, b);
}
...
function CartesianContextProvider(props) {
  ...
  const drawingArea = React8.useContext(DrawingContext);
  ...
  const value = React8.useMemo(() => {
    ...
    const allXAxis = [
      ...(_xAxis$map = xAxis == null ? void 0 : xAxis.map((axis, index2) => _extends({
        id: `deaultized-x-axis-${index2}`
    ...
    allXAxis.forEach((axis, axisIndex) => {
      ...
      const range2 = [drawingArea.left, drawingArea.left + drawingArea.width];
    ...
    const allYAxis = [...(_yAxis$map = yAxis == null ? void 0 : yAxis.map((axis, index2) => _extends({
      id: `deaultized-y-axis-${index2}`
    ...
    allYAxis.forEach((axis, axisIndex) => {
      ...
      const range2 = [drawingArea.top + drawingArea.height, drawingArea.top];
      if (isBandScaleConfig(axis)) {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const {
    ...
    top,
    left
  } = React9.useContext(DrawingContext);
  const {
    xAxis,
    yAxis,
    xAxisIds,
  ...
  const mousePosition = React9.useRef({
    x: -1,
    y: -1
  });
  React9.useEffect(() => {
    ...
    const getUpdate = (axisConfig, mouseValue) => {
      ...
      if (!isBandScale(scale)) {
        ...
        const closestIndex = axisData == null ? void 0 : axisData.findIndex((v, index2) => {
          if (v > value) {
            if (index2 === 0 || Math.abs(value - v) <= Math.abs(value - axisData[index2 - 1])) {
              return true;
            }
          }
          if (v <= value) {
            if (index2 === axisData.length - 1 || // @ts-ignore
            Math.abs(value - v) < Math.abs(value - axisData[index2 + 1])) {
              return true;
            }
          }
          return false;
...
var ChartsSurface = React10.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
var HighlighContext = React11.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React11.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React11.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime7.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
...
var ChartContainer = React12.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime8.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime8.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime8.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime8.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime8.jsx)(HighlightProvider, {
...
var ResponsiveChartContainer = React13.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
...
function ChartsText(props) {
  ...
  const wordsByLines = React14.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime10.jsx)("text", _extends({}, textProps, {
    x: x2,
    y: y2,
    textAnchor,
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime10.jsx)("tspan", {
      x: x2,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React16.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber
...
true ? ChartsXAxis.propTypes = {
   ...
   */
  axisId: import_prop_types5.default.string,
  /**
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React17.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
    ...
    children: [!disableLine && (0, import_jsx_runtime13.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime14.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime13.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime13.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
true ? ChartsYAxis.propTypes = {
   ...
   * If undefined, it will be the first defined axis.
   */
  axisId: import_prop_types6.default.string,
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime16.jsxs)(React18.Fragment, {
    children: [topId && (0, import_jsx_runtime15.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime15.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime15.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime15.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
true ? ChartsAxis.propTypes = {
  ...
  bottomAxis: import_prop_types7.default.oneOfType([import_prop_types7.default.shape({
    axisId: import_prop_types7.default.string,
...
function useMouseTracker() {
  const svgRef = React19.useContext(SVGContext);
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime17.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime17.jsx)("tbody", {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
  ...
  itemData: import_prop_types8.default.shape({
    ...
    seriesId: import_prop_types8.default.string.isRequired,
    type: import_prop_types8.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
   * The series linked to the triggered axis.
   */
  series: import_prop_types8.default.shape({
    color: import_prop_types8.default.string,
    data: import_prop_types8.default.oneOfType([import_prop_types8.default.arrayOf(import_prop_types8.default.number), import_prop_types8.default.arrayOf(import_prop_types8.default.number), import_prop_types8.default.arrayOf(import_prop_types8.default.shape({
    ...
    })), import_prop_types8.default.arrayOf(import_prop_types8.default.shape({
    ...
    type: import_prop_types8.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
    valueFormatter: import_prop_types8.default.func.isRequired
  }).isRequired,
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React21.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types9.default.shape({
    classes: import_prop_types9.default.object,
    itemData: import_prop_types9.default.shape({
      dataIndex: import_prop_types9.default.number,
      seriesId: import_prop_types9.default.string.isRequired,
      type: import_prop_types9.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types9.default.shape({
      color: import_prop_types9.default.string,
      data: import_prop_types9.default.oneOfType([import_prop_types9.default.arrayOf(import_prop_types9.default.number), import_prop_types9.default.arrayOf(import_prop_types9.default.number), import_prop_types9.default.arrayOf(import_prop_types9.default.shape({
        id: import_prop_types9.default.oneOfType([import_prop_types9.default.number, import_prop_types9.default.string]).isRequired,
        x: import_prop_types9.default.number.isRequired,
        y: import_prop_types9.default.number.isRequired
      })), import_prop_types9.default.arrayOf(import_prop_types9.default.shape({
      ...
      highlightScope: import_prop_types9.default.shape({
        faded: import_prop_types9.default.oneOf(["global", "none", "series"]),
        highlighted: import_prop_types9.default.oneOf(["item", "none", "series"])
      }),
      id: import_prop_types9.default.string.isRequired,
      type: import_prop_types9.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
      valueFormatter: import_prop_types9.default.func.isRequired
    }),
        ...
        children: series.map(({
          ...
          return (0, import_jsx_runtime21.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime20.jsx)(ChartsTooltipCell, {
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime20.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime20.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
  ...
  axisData: import_prop_types10.default.shape({
    x: import_prop_types10.default.shape({
      ...
      value: import_prop_types10.default.oneOfType([import_prop_types10.default.instanceOf(Date), import_prop_types10.default.number]).isRequired
    }),
   ...
   */
  axisValue: import_prop_types10.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React24.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React24.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React24.useMemo(() => {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  axisData: import_prop_types11.default.shape({
    x: import_prop_types11.default.shape({
      ...
      value: import_prop_types11.default.oneOfType([import_prop_types11.default.instanceOf(Date), import_prop_types11.default.number]).isRequired
    }),
  ...
  contentProps: import_prop_types11.default.shape({
    axis: import_prop_types11.default.object,
    axisData: import_prop_types11.default.shape({
      x: import_prop_types11.default.shape({
        index: import_prop_types11.default.number,
        value: import_prop_types11.default.oneOfType([import_prop_types11.default.instanceOf(Date), import_prop_types11.default.number]).isRequired
    ...
    axisValue: import_prop_types11.default.any,
    classes: import_prop_types11.default.object,
    dataIndex: import_prop_types11.default.number,
    series: import_prop_types11.default.arrayOf(import_prop_types11.default.object),
...
function DefaultChartsLegend(props) {
  ...
  const theme = useTheme();
  const labelStyle = React26.useMemo(
  ...
  const padding = React26.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React26.useCallback((label, inStyle = {}) => {
  ...
  const seriesWithPosition = React26.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
  ...
  return (0, import_jsx_runtime24.jsx)(NoSsr, {
    children: (0, import_jsx_runtime24.jsx)(ChartsLegendRoot, {
      className: classes.root,
...
true ? DefaultChartsLegend.propTypes = {
  ...
  series: import_prop_types13.default.shape({
    bar: import_prop_types13.default.shape({
      series: import_prop_types13.default.object.isRequired,
      seriesOrder: import_prop_types13.default.arrayOf(import_prop_types13.default.string).isRequired,
      stackingGroups: import_prop_types13.default.arrayOf(import_prop_types13.default.shape({
        ids: import_prop_types13.default.arrayOf(import_prop_types13.default.string).isRequired,
        stackingOffset: import_prop_types13.default.func.isRequired,
        stackingOrder: import_prop_types13.default.func.isRequired
      })).isRequired
    }),
    line: import_prop_types13.default.shape({
      series: import_prop_types13.default.object.isRequired,
      seriesOrder: import_prop_types13.default.arrayOf(import_prop_types13.default.string).isRequired,
      stackingGroups: import_prop_types13.default.arrayOf(import_prop_types13.default.shape({
        ids: import_prop_types13.default.arrayOf(import_prop_types13.default.string).isRequired,
    ...
    pie: import_prop_types13.default.shape({
      series: import_prop_types13.default.object.isRequired,
      seriesOrder: import_prop_types13.default.arrayOf(import_prop_types13.default.string).isRequired
    }),
    scatter: import_prop_types13.default.shape({
      series: import_prop_types13.default.object.isRequired,
      seriesOrder: import_prop_types13.default.arrayOf(import_prop_types13.default.string).isRequired
    })
  }).isRequired,
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React26.useContext(DrawingContext);
  const series = React26.useContext(SeriesContext);
...
function ChartsAxisHighlight(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React28.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime27.jsxs)(React28.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime26.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime26.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime26.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime26.jsx)(ChartsAxisHighlightPath, {
...
var useInteractionItemProps = (scope) => {
  ...
  } = React29.useContext(HighlighContext);
...
//# sourceMappingURL=chunk-MZOBWY6J.js.map
